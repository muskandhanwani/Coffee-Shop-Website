              ...
              >
                <div className="relative z-10 space-y-4">
                  ...
                  <h1 className="text-sm opacity-55 leading-loose">
                    ...
                    Perspiciatis reprehenderit illo culpa a libero autem commodi
                    quo, ex doloremque ab amet aut, repellat sunt quaerat
                    excepturi consequuntur blanditiis debitis quia!
                  </h1>
                </div>
